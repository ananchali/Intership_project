...
<body class="bg-gray-50">
    ...
    <header class="bg-white/80 backdrop-blur-lg shadow-sm sticky top-0 z-50 transition-all duration-300 border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <!-- Right side: Theme toggle + Language switcher + Hamburger (visible on all sizes) -->
                <div class="flex items-center gap-1">
                    <!-- Dark/Light Mode Toggle -->
                    <button id="themeToggle" class="p-2 rounded-lg text-gray-700 hover:text-blue-600 hover:bg-gray-100 transition-all" onclick="toggleTheme()" title="Toggle Dark/Light Mode">
    ...
    <!-- Mobile Menu (outside header to prevent fixed positioning issues) -->
    <div id="mobileMenu" style="display:none; position:fixed; top:0; left:0; width:100vw; height:100vh; z-index:9999; background:#fff; overflow-y:auto;">
        <div style="padding:1rem;">
            <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:1.5rem;">
                <div style="display:flex; align-items:center;">
                    <div style="width:2.5rem; height:2.5rem; border-radius:9999px; overflow:hidden; background:#fff; display:flex; align-items:center; justify-content:center; margin-right:0.75rem;">
                        <img src="{{ asset('images/logo.png') }}" alt="Afronex Logo" style="width:100%; height:100%; object-fit:cover;">
                    </div>
                    <span style="font-size:1.25rem; font-weight:900; color:#111; letter-spacing:-0.025em;">AFRONEX<span style="color:#2563eb;">HOST</span></span>
                </div>
                <button onclick="toggleMobileMenu()" style="padding:0.5rem; border-radius:0.5rem; color:#374151; background:transparent; border:none; cursor:pointer;">
            ...
            <nav style="display:flex; flex-direction:column; gap:1rem;">
                <div style="border-top:1px solid #e5e7eb; padding-top:1rem;">
                    <h3 style="font-weight:600; color:#111; margin-bottom:0.75rem;">Web Hosting</h3>
                    <div style="display:flex; flex-direction:column; gap:0.5rem;">
                        <a href="{{ route('packages.index') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Shared Hosting</a>
                        <a href="#" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Free Hosting</a>
                        <a href="#" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">VPS Hosting</a>
                    </div>
                </div>

                <div style="border-top:1px solid #e5e7eb; padding-top:1rem;">
                    <h3 style="font-weight:600; color:#111; margin-bottom:0.75rem;">How To</h3>
                    <div style="display:flex; flex-direction:column; gap:0.5rem;">
                        <a href="{{ route('howto.buy') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Buy Domain & Hosting</a>
                        <a href="{{ route('howto.hosting') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Buy Hosting Only</a>
                        <a href="{{ route('howto.transfer') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Transfer to Afronex</a>
                    </div>
                </div>

                <div style="border-top:1px solid #e5e7eb; padding-top:1rem; display:flex; flex-direction:column; gap:0.5rem;">
                    <a href="{{ route('contact') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Contact</a>
                    @auth
                        <a href="{{ route('customer.dashboard') }}" style="display:block; padding:0.5rem 0; color:#2563eb; font-weight:500; text-decoration:none;">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" style="display:block; padding:0.5rem 0; color:#374151; text-decoration:none;">Login</a>
                    @endauth
                </div>
