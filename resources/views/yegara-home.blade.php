    ...
    <div class="max-w-7xl mx-auto px-4 relative z-10 w-full">
        <div class="text-center max-w-4xl mx-auto">
            ...
            <h1 class="text-5xl md:text-7xl font-black mb-8 leading-tight tracking-tight drop-shadow-lg">
                @if(app()->getLocale() == 'om')
                <span class="notranslate" data-i18n="hero-title-main">Marshoota Keessan </span><br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400 notranslate" data-i18n="hero-title-sub">Kaffaltiiwwan Keessan Mirkaneessaa</span>
                @else
                <span data-i18n="hero-title-main">Host Your Website. </span><br>
                <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400" data-i18n="hero-title-sub">Verify Your Payments. No Slips, No Hassle.</span>
                @endif
            </h1>
            <p class="text-xl md:text-2xl mb-12 text-gray-300 font-light max-w-3xl mx-auto" data-i18n="hero-desc">
                Fast, secure web hosting with instant payment verification. No more waiting for payment slips.
            </p>
